module CalculatorStocks
  ...
  def get_order_products
    ...
    period_id_before = Period.period_id_before(params.fetch(:period_id)) || 0
    @remainders = Remainder.for_the_period(params.fetch(:user_id), period_id_before).currents_true
