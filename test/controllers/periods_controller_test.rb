...
class PeriodsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create period" do
    assert_difference('Period.count') do
      post periods_url, params: { period: { days: @period.days, finish_date: @period.finish_date, start_date: @period.start_date } }
    end
  ...
  test "should update period" do
    patch period_url(@period), params: { period: { days: @period.days, finish_date: @period.finish_date, start_date: @period.start_date } }
